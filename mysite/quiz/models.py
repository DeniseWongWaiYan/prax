...
class GamePlay(models.Model):
    student = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.DO_NOTHING, default=0, null=True)
    character = models.IntegerField(verbose_name=_("Current Score"))
    current_position = models.IntegerField(verbose_name=_("Current Score"))
    level = models.IntegerField(verbose_name=_("Current Score"))
    money = models.IntegerField(verbose_name=_("Current Score"))
    weapons = models.IntegerField(verbose_name=_("Current Score"))
